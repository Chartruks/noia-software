...
const APPS = [
  {
    ...
    features: [
      { kicker: 'Disguised entry', name: 'A private vault in plain sight', desc: 'A fully functional calculator keeps private storage unobtrusive while a personal code opens the vault.', points: ['Use primary or optional secondary codes to open separate galleries.', 'Leaving the app immediately locks access again.'], screen: 'assets/apps/hushcalc/feature-01.png' },
      { kicker: 'Local-only organization', name: 'A polished gallery without the cloud', desc: 'Albums, favorites, search, and sorting make a private library useful every day while its contents stay on the device.', points: ['Browse large collections in a clear, familiar grid.', 'No account or remote photo library is required.'], screen: 'assets/apps/hushcalc/feature-02.png' },
      { kicker: 'Multi-format vault', name: 'Every important format in one safe place', desc: 'Photos, videos, Live Photos, and files share one consistent private browsing experience.', points: ['Media types stay clear through Live Photo, video, and document indicators.', 'Search, favorites, previews, and albums work across formats.'], screen: 'assets/apps/hushcalc/feature-03.png' },
      { kicker: 'Fast import', name: 'Import exactly what you need', desc: 'One add menu handles photos, videos, Live Photos, files, and nested albums without interrupting the gallery workflow.', points: ['Progress feedback supports larger imports.', 'Create albums inside albums as content is added.'], screen: 'assets/apps/hushcalc/feature-04.png' },
      { kicker: 'Nearby transfer', name: 'Move privately between Apple devices', desc: 'Send selected vault items directly between HushCalc on iPhone and iPad without uploading them to a cloud service.', points: ['Choose the receiving device and the exact items to move.', 'Visible progress and confirmation guide the handoff.'], screen: 'assets/apps/hushcalc/feature-05.png' },
      { kicker: 'Portable encrypted backup', name: 'Your backup. Your password.', desc: 'Create a password-protected safety copy that can be stored wherever you choose and restored later.', points: ['One encrypted archive carries the vault structure and protected content.', 'Restore verifies and merges without replacing the current library.'], screen: 'assets/apps/hushcalc/feature-06.png' },
    ],
  },
  {
